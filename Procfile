...
#     echo '{ "name": "stickynotes-backend", "version": "0.0.1", "dependencies": {} }' >> package.json
#
...
#
#     git checkout deploy
#     git add ./dist/build/stickynotes-backend/stickynotes-backend
#     git commit -m deploy
#
# * push to Heroku
#
...
web: ./dist/build/stickynotes-backend/stickynotes-backend production -p $PORT
